export class Urls {
  private static BACKEND_ADDRESS = 'http://localhost:8080';

  private static LABEL_ASSOCIATION_CONTROLLER   = Urls.BACKEND_ADDRESS + '/labelAssociation';
  ...
  private static LABEL_CONTROLLER = Urls.BACKEND_ADDRESS + '/label';
  ...
  private static PERSON_CONTROLLER    = Urls.BACKEND_ADDRESS + '/people';
  ...
  private static RESERVATION_CONTROLLER       = Urls.BACKEND_ADDRESS + '/reservation';
  ...
  private static ROOM_CONTROLLER        = Urls.BACKEND_ADDRESS + '/room';
